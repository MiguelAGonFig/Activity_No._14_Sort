...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout_6.addWidget(self.Salida, 0, 1, 1, 1)
        ...
        self.Ordenar_ID_pushButton_2 = QPushButton(self.groupBox_3)
        self.Ordenar_ID_pushButton_2.setObjectName(u"Ordenar_ID_pushButton_2")

        self.gridLayout_3.addWidget(self.Ordenar_ID_pushButton_2, 0, 0, 1, 1)

        self.Ordenar_Distancia_pushButton_2 = QPushButton(self.groupBox_3)
        self.Ordenar_Distancia_pushButton_2.setObjectName(u"Ordenar_Distancia_pushButton_2")

        self.gridLayout_3.addWidget(self.Ordenar_Distancia_pushButton_2, 0, 1, 1, 1)

        self.Ordenar_Velocidad_pushButton_2 = QPushButton(self.groupBox_3)
        self.Ordenar_Velocidad_pushButton_2.setObjectName(u"Ordenar_Velocidad_pushButton_2")

        self.gridLayout_3.addWidget(self.Ordenar_Velocidad_pushButton_2, 0, 2, 1, 1)


        self.gridLayout_7.addWidget(self.groupBox_3, 2, 0, 1, 3)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.groupBox_3.setTitle(QCoreApplication.translate("MainWindow", u"Ordenar", None))
        self.Ordenar_ID_pushButton_2.setText(QCoreApplication.translate("MainWindow", u"ID - Ascendente", None))
        self.Ordenar_Distancia_pushButton_2.setText(QCoreApplication.translate("MainWindow", u"Distancia - Descendente", None))
        self.Ordenar_Velocidad_pushButton_2.setText(QCoreApplication.translate("MainWindow", u"Velocidad - Ascendente", None))
